...
class Shop implements Inventory{
    ...
    constructor(id:number,name:string,price:number,quant:number){
        this.id =  id;
        this.name =name;
        this.price =price;
        this.quanity =quant;
     ...
     checkquantity(): void {
        ...
        console.log(`Current Quantity:  ${this.quanity}`);
    }

    getorder(q:number): void{
        if(q>this.quanity){
            console.log(`You cannot order than ${this.quanity} items`);
        }else{
