...
router.get('/emps/:empID/child/assignments', (req, res) => {
...
router.get('/emps/:empID/child/assignments/:AssignmentID', (req, res) => {
    const emp = employee.employee.find(c => c.LegalEntityId === parseInt(req.params.empID));
    if (!emp) return res.status(404).send('The employee with given id was not found');
...
router.post('/emps/:empID/child/assignments', (req, res) => {
...
router.put('/emps/:empID/child/assignments/:AssignmentID', (req, res) => {
    const emp = employee.employee.find(c => c.LegalEntityId === parseInt(req.params.empID));
    if (!emp) return res.status(404).send('The employee with given id was not found');
